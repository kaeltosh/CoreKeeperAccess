...
À jour à l'alpha 1 (build 51). Merci de consulter cette liste avant d'ouvrir une issue — si vous rencontrez un de ces points, inutile de le signaler sauf élément nouveau.
...
- **Onglet Âmes : la bascule activer/désactiver (Croix) n'est pas testée.** La navigation de l'onglet est implémentée mais n'a pas pu être vérifiée en jeu (âmes non débloquées sur la partie de test). L'état n'est pas non plus réannoncé après bascule.
...
- **Multijoueur non testé.** Le mod est côté client ; testez en solo.
...
- **L'automation avancée** (foreuses, convoyeurs, bras robotiques, réseau électrique) : jalon dédié prévu.
- **Les torches-balises audio** (« fil d'Ariane » que l'on pose soi-même et suit à l'oreille) : conçu, pas construit.
