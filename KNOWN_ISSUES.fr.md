...
À jour à la 1.0.17 beta. Merci de consulter cette liste avant d'ouvrir une issue — si vous rencontrez un de ces points, inutile de le signaler sauf élément nouveau.
...
- **Toute la vague 1.0.16 build 2 (annonces de boss) est codée mais n'a pas été jouée.** Les annonces de combat sont désormais les mêmes pour **tous** les boss du jeu : le nom du boss est prononcé quand il s'enrage, change de phase, devient invulnérable — ou redevient attaquable — et quand il meurt, y compris pour des boss que personne n'a encore affrontés avec le mod. S'y ajoutent l'annonce d'une attaque imminente sur plusieurs boss, l'apparition et la disparition de trois d'entre eux, et une file de priorités pour que deux annonces ne se coupent plus l'une l'autre. Sur un boss composé de plusieurs parties, l'annonce de vie suit maintenant la partie principale au lieu de sauter de l'une à l'autre. Enfin, l'annonce de la forme des vagues d'Azeos et les paliers de vie existent aussi **en anglais** (ils étaient figés en français), et toute autre langue les entend via le lecteur d'écran. **Rien de tout ça n'a été vérifié en combat** — seulement au démarrage du jeu : un retour sur un combat de boss, n'importe lequel, est particulièrement utile.
- **Toute la vague 1.0.17 est codée mais n'a pas encore été jouée** : les carrelages caverneux (et les grands carreaux de pierre des ruines) ne masquent plus ce qu'on pose dessus — une lampe ou une porte électrique posée sur ce sol restait introuvable au curseur, alors qu'une scie circulaire au même endroit s'annonçait bien ; dans la foulée, les appareils électriques sans interface (porte électrique, lampe câblée) ne se font plus écraser par n'importe quel meuble occupant la même case. Le journal des dialogues, lui, n'affiche plus le discours d'éveil du Cœur tant que vous ne lui avez pas parlé : il donnait une direction vers la Grande Muraille alors que le mur reste sourd jusque-là, de quoi croire une partie bloquée — les journaux déjà remplis à tort se nettoient d'eux-mêmes à la prochaine ouverture. Enfin, la lecture de progression (Triangle+bas) annonce « 3 cristaux posés » au lieu d'un « activé » trompeur, et réclame explicitement d'aller parler au Cœur quand c'est l'étape qui manque.
